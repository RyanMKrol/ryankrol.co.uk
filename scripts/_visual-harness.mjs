...
export const PAGES = [
  ...
  { name: 'reviews-movies-add', path: '/reviews/movies/add', waitFor: ['.collection-form-card'], description: 'Movie review add form — MarkdownEditor with a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/movies/add.js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-movies-edit-detail', path: '/reviews/movies/edit/id-dune', waitFor: ['.collection-form-card'], description: 'Movie review edit detail form — MarkdownEditor pre-filled with the review plus a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/movies/edit/[id].js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-tv-add', path: '/reviews/tv/add', waitFor: ['.collection-form-card'], description: 'TV review add form — MarkdownEditor with a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/tv/add.js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-tv-edit-detail', path: '/reviews/tv/edit/id-andor', waitFor: ['.collection-form-card'], description: 'TV review edit detail form — MarkdownEditor pre-filled with the review plus a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/tv/edit/[id].js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-books-add', path: '/reviews/books/add', waitFor: ['.collection-form-card'], description: 'Book review add form — MarkdownEditor with a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/books/add.js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-books-edit-detail', path: '/reviews/books/edit/bk-piranesi', waitFor: ['.collection-form-card'], description: 'Book review edit detail form — MarkdownEditor pre-filled with the review plus a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/books/edit/[id].js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-albums-add', path: '/reviews/albums/add', waitFor: ['.collection-form-card'], description: 'Album review add form — MarkdownEditor with a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/albums/add.js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-albums-edit-detail', path: '/reviews/albums/edit/al-for-ever', waitFor: ['.collection-form-card'], description: 'Album review edit detail form — MarkdownEditor pre-filled with the highlights plus a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/albums/edit/[id].js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-perfumes-add', path: '/reviews/perfumes/add', waitFor: ['.collection-form-card'], description: 'Perfume review add form — MarkdownEditor with a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/perfumes/add.js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
  { name: 'reviews-perfumes-edit-detail', path: '/reviews/perfumes/edit/pf-nu-e-bleue', waitFor: ['.collection-form-card'], description: 'Perfume review edit detail form — MarkdownEditor pre-filled with the description plus a live Markdown preview pane underneath (T393).', covers: ['src/pages/reviews/perfumes/edit/[id].js', 'src/components/MarkdownEditor.js', 'src/components/Markdown.js', 'src/styles/globals.css'] },
...
const bespokeFlows = [
  ...
  { name: 'perfumes-designer-filter', path: '/reviews/perfumes', waitFor: ['.perfume-v6-card'], flow: 'Click the designer name on a perfume card; the search box fills with that designer and the list narrows to their perfumes.', description: 'Perfumes filtered by clicking a designer name.', covers: ['src/pages/reviews/perfumes/index.js', 'src/components/perfumeVariants/Variant6Hybrid.js', 'src/components/SearchInput.js'], actions: async (page) => { await page.click('.perfume-v6-card:first-child button.perfume-v1-designer'); } },
  { name: 'perfumes-empty-state', path: '/reviews/perfumes', waitFor: ['.collection-review-header'], flow: 'Search for "zzznonexistent" to find no matching perfumes; the empty-state card displays.', description: 'Perfumes empty state when search matches zero items.', covers: ['src/pages/reviews/perfumes/index.js', 'src/styles/globals.css'], actions: async (page) => { await page.fill('.collection-search-input input', 'zzznonexistent'); await page.waitForSelector('.perfume-empty-state', { state: 'visible', timeout: 10000 }); } },
