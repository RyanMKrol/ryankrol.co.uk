...
export const PAGES = [
  ...
  { name: 'reviews-books', path: '/reviews/books', waitFor: ['.spine-cover-card'], description: 'Book reviews — spine-cover cards.', covers: ['src/pages/reviews/books/index.js', ...REVIEW_COMMON] },
