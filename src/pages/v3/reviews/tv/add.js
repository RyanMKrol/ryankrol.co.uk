...
export default function V3AddTVReview() {
  ...
  const handleSubmit = async () => {
    ...
    router.push('/v3/reviews/tv');
  };

  return (
    <V3Layout title="tv — add">
      <V3AddEntry type="tv" onSubmit={handleSubmit} disabled={formData.rating === 0}>
        <label>
          title{' '}
