...
describe('diffMigratedItem', () => {
  ...
  it('detects a changed field', () => {
    const newItem = { ...sampleOldItem, id: 'some-uuid', thumbnail: 'https://example.com/other.jpg' };
    const mismatches = diffMigratedItem(sampleOldItem, newItem);

    expect(mismatches).toHaveLength(1);
    expect(mismatches[0]).toMatchObject({
      field: 'thumbnail',
      oldValue: 'https://example.com/cover.jpg',
      newValue: 'https://example.com/other.jpg',
    });
  });
