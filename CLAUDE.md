...
| `src/pages/api/books/search.js` | Open Library book-search proxy (`?title=` required, `?author=` optional); keyless, returns normalised book list via `withApiCache`; missing `title` → 400 |
